          ...
          builder: (kycVerifyController) {
            return SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(height: 100,padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                      decoration: BoxDecoration(
                                          ...
                                          borderRadius: const BorderRadius.all(Radius.circular(Dimensions.PADDING_SIZE_DEFAULT))
                                      ),
                                      child: const Padding(
    ...
    return DottedBorder(
      ...
      child: CustomInkWell(
        ...
        child: path != null ? Padding(
          ...
          child: ClipRRect(
            borderRadius: const BorderRadius.all(Radius.circular(Dimensions.PADDING_SIZE_SMALL)),
            child: Image.file(
              File(path),
