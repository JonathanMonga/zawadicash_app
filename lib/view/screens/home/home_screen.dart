                        ...
                        return Column(
                          children: [
                            splashController.configModel.themeIndex == '1'
                                ? GetBuilder<ProfileController>(builder: (profile)=> const FirstCardPortion())
                                : splashController.configModel.themeIndex == '2' ? const SecondCardPortion() : splashController.configModel.themeIndex == '3' ? const ThirdCardPortion() :
                            GetBuilder<ProfileController>(builder: (profile)=> const FirstCardPortion()),

                            const SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),

                            GetBuilder<WebsiteLinkController>(builder: (websiteLinkController){
                              return websiteLinkController.isLoading ? const WebSiteShimmer() :
                              websiteLinkController.websiteList.isNotEmpty ?  const LinkedWebsite() : const SizedBox();
                            }),
