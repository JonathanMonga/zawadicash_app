...
import 'package:zawadicash_app/view/screens/deshboard/widget/unicorn_outline_button.dart';
            ...
            return Scaffold(
              ...
              floatingActionButton: UnicornOutlineButton(strokeWidth: 1.5, radius: 50,
                ...
                child: FloatingActionButton(backgroundColor: Theme.of(context).secondaryHeaderColor, elevation: 1,
                  onPressed: () =>  Get.to(() => const CameraScreen(fromEditProfile: false, isBarCodeScan: true, isHome: true)),
