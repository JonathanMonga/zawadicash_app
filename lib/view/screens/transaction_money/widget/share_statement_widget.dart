                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      widget.transactionType != 'request_money' ? Text('${'charge'.tr} ${widget.charge}', style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE,color: Theme.of(context).primaryColor)) : const SizedBox.shrink(),
                      const SizedBox(
                        height: Dimensions.PADDING_SIZE_DEFAULT,
                      ),
                      Divider(
                      ...
                      Center(child: Text('${widget.contactModel.name ?? ''} (${widget.contactModel.phoneNumber})', textAlign : TextAlign.center,
                          style: rubikRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: Theme.of(context).primaryColor))),

                      const SizedBox(height: Dimensions.PADDING_SIZE_SMALL),

                      widget.trxId != null ?  Text( '${'trx_id'.tr}: ${widget.trxId}', style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT)) : const SizedBox(),
