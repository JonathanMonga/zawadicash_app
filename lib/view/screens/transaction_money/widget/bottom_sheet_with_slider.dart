    ...
    return WillPopScope(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          borderRadius: const BorderRadius.only(topLeft: Radius.circular(Dimensions.RADIUS_SIZE_LARGE), topRight:Radius.circular(Dimensions.RADIUS_SIZE_LARGE) ),
        ),
            ...
            return Column(
              ...
              children: [
                        ...
                        child: GestureDetector(onTap: ()=> Get.back(),
                            child: Container(
                              padding: const EdgeInsets.all(10),
                                ...
                                child: const Icon(Icons.clear,size: Dimensions.PADDING_SIZE_DEFAULT,))),
                      ),
                    ) : const SizedBox(),
                  ],
                ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(widget.transactionType=='send_money'? 'send_money_successful'.tr : widget.transactionType=='request_money'?'request_send_successful'.tr:'cash_out_successful'.tr,
                          style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: Theme.of(context).textTheme.titleLarge.color)):const SizedBox(),
                ...
                Column(
                  children: [
                    const Padding(
                      padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_DEFAULT / 1.7),
                      child: Divider(height: Dimensions.DIVIDER_SIZE_SMALL),
                    ),
                    const SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
