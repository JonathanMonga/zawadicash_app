...
class ContactView extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return !contactController.contactIsLoading? AzListView(
        ...
        itemBuilder: (context, index) => contactController.filterdContacts[index] == null ? const SizedBox() : Column(
          ...
          children: [
            ...
            Padding( padding: contactController.filterdContacts[index].isShowSuspension ?
              const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_LARGE, vertical: Dimensions.PADDING_SIZE_SMALL) :
