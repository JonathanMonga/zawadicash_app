...
import 'package:zawadicash_app/pages/auth/login/verification_page.dart';
import 'package:zawadicash_app/utils/constants.dart';

import 'package:zawadicash_app/components/c_text_form_field.dart';
import 'package:zawadicash_app/components/secondary_button.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) =>
            PasswordProvider(), // ← create/init your state model
        child: Scaffold(
