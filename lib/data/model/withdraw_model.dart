...
class WithdrawModel {
  ...
  factory WithdrawModel.fromRawJson(String str) =>
      WithdrawModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory WithdrawModel.fromJson(Map<String, dynamic> json) => WithdrawModel(
        withdrawalMethods: List<WithdrawalMethod>.from(
            json["content"].map((x) => WithdrawalMethod.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "message": message,
        "withdrawal_methods":
            List<dynamic>.from(withdrawalMethods.map((x) => x.toJson())),
      };
}
...
class WithdrawalMethod {
  ...
  factory WithdrawalMethod.fromRawJson(String str) =>
      WithdrawalMethod.fromJson(json.decode(str));
  ...
  factory WithdrawalMethod.fromJson(Map<String, dynamic> json) =>
      WithdrawalMethod(
        ...
        methodFields: List<MethodField>.from(
            json["method_fields"].map((x) => MethodField.fromJson(x))),
      );
...
class MethodField {
  ...
  factory MethodField.fromRawJson(String str) =>
      MethodField.fromJson(json.decode(str));
