...
import 'package:zawadicash_app/pages/auth/login/login_face_unlock_page.dart';
import 'package:zawadicash_app/pages/auth/login/pin_code_page.dart';
import 'package:zawadicash_app/pages/auth/register/register_fingerprint_unlock_page.dart';
import 'package:zawadicash_app/pages/auth/register/register_page.dart';
import 'package:zawadicash_app/pages/card/add_card_page.dart';
import 'package:zawadicash_app/pages/dashboard/add_new_account/add_new_account_page.dart';
import 'package:zawadicash_app/pages/dashboard/saving/add_saving_page.dart';
import 'package:zawadicash_app/pages/dashboard/saving/saving_page.dart';
import 'package:zawadicash_app/pages/dashboard/transfer/transfer_bank_page.dart';
import 'package:zawadicash_app/pages/dashboard/transfer/transfer_page.dart';
import 'package:zawadicash_app/pages/dashboard/transfer/transfer_successful_page.dart';
import 'package:zawadicash_app/pages/dashboard/transfer/transfer_to_friends_page.dart';
import 'package:zawadicash_app/pages/dashboard/withdraw/withdraw_code_page.dart';
import 'package:zawadicash_app/pages/dashboard/withdraw/withdraw_page.dart';
import 'package:zawadicash_app/pages/onboard/onbording_page.dart';
import 'package:zawadicash_app/pages/profile/security_page.dart';
import 'package:zawadicash_app/pages/scan/scan_page.dart';
import 'package:zawadicash_app/pages/splash/splash_page.dart';

import 'package:zawadicash_app/pages/auth/login/login_finger_print_page.dart';
import 'package:zawadicash_app/pages/auth/login/login_page.dart';
import 'package:zawadicash_app/pages/auth/register/capture_identity_card_page.dart';
import 'package:zawadicash_app/pages/auth/register/register_face_unlock_page.dart';
import 'package:zawadicash_app/pages/auth/register/register_success_page.dart';
import 'package:zawadicash_app/pages/dashboard/notification/notification_page.dart';
import 'package:zawadicash_app/pages/dashboard/payment/payment_page.dart';
import 'package:zawadicash_app/pages/navigation/navigation_page.dart';
import 'package:zawadicash_app/pages/profile/manage_notification_page.dart';
